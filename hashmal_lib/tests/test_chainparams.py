...
clams_fields.insert(1, Field('Timestamp', b'<i', 4, 0))
clams_fields.append(Field('ClamSpeech', 'bytes', None, b''))

peercoin_fields = list(bitcoin_fields)
peercoin_fields.insert(1, Field('Timestamp', b'<i', 4, 0))
...
class TransactionTest(unittest.TestCase):
    ...
    def test_clams_fields(self):
        ...
        self.assertIn(Field('ClamSpeech', 'bytes', None, b''), tx.fields)
    ...
    def test_peercoin_fields(self):
        ...
        self.assertNotEqual(bitcoin_fields, tx.fields)
        self.assertIn(Field('Timestamp', b'<i', 4, 0), tx.fields)
...
bitcoin_block_fields = [
    Field('vtx', 'vectortx', None, None)
]

clams_block_fields = list(bitcoin_block_fields) + [Field('blockSig', 'bytes', None, None)]
...
class BlockTest(unittest.TestCase):
    ...
    def test_clams_fields(self):
        ...
        self.assertEqual(clams_block_fields, blk.block_fields)
